...
computable. We approximate it by comparing the current implied volatility to
the trailing range of *realized* (historical) volatility. It's a proxy --
clearly labelled as such on the resulting :class:`IVRank` -- and still a
useful gauge of whether options premium is rich or cheap relative to how the
...
from .models import IVRank, PriceBar
